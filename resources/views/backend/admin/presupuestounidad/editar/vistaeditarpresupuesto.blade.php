    ...
    <script>
        ...
        function verificar() {
            Swal.fire({
                ...
                if (result.isConfirmed) { editarPresupuesto(); }
            });
        }

        // verificarNuevoMaterial y editarPresupuesto están en el contenedor (tienen acceso a $arrayMeses)
        // Las funciones de proyecto también
        ...
        function verificarNuevoMaterial() {
            ...
            if (!costo.match(reglaNumeroDosDecimal)) { toastr.error('Costo debe ser número Decimal Positivo. Solo se permite 2 Decimales'); return; }
            if (costo < 0) { toastr.error('Costo no permite números negativos'); return; }
            if (costo > 99000000) { toastr.error('Costo máximo 99 millones'); return; }
            ...
            if (cantidad > 99000000) { toastr.error('Cantidad máximo 99 millones'); return; }
            ...
            if (periodo <= 0) { toastr.error('Periodo no permite Cero o negativos'); return; }
